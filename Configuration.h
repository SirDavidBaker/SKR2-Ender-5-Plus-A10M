...
#define STRING_CONFIG_H_AUTHOR "(Ender-5 Plus SKR2)" // Who made the changes.
 ...
 */
  ...
  #define TEMP_SENSOR_REDUNDANT_MAX_DIFF  15  // (°C) Temperature difference that will trigger a print abort.
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 31.87
    #define DEFAULT_Ki 2.09
    #define DEFAULT_Kd 121.73
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 100, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, 0, -5 }
